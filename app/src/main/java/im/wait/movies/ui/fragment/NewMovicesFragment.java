 ...
 */
public class NewMovicesFragment extends BaseFragment {
    ...
    public static NewMovicesFragment newInstance(Bundle bundle) {
        NewMovicesFragment fragment = new NewMovicesFragment();
    ...
    protected int getContentView() {
        return R.layout.fragment_newmovices;
    }
    ...
    protected void initDatas() {
        ...
        mApi.getNewMovices(new SimpleJoyResponce<SubjectsModel>() {
            @Override
