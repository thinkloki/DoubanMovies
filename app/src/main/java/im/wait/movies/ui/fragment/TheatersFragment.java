 ...
 */
public class TheatersFragment extends BaseFragment {
    ...
    public static TheatersFragment newInstance(Bundle bundle) {
    ...
    protected void initDatas() {
        ...
        mApi.getTheaters("北京", new SimpleJoyResponce<SubjectsModel>() {
            @Override
